...
static int test_vec_memcpy()
{
...

	{
		...
		glm::ivec1 B;
		std::memcpy(static_cast<void*>(&B), &A, sizeof(glm::ivec1));
		Error += B == A ? 0 : 1;
	}

	{
		...
		glm::ivec2 B;
		std::memcpy(static_cast<void*>(&B), &A, sizeof(glm::ivec2));
		Error += B == A ? 0 : 1;
	}

	{
		...
		glm::ivec3 B;
		std::memcpy(static_cast<void*>(&B), &A, sizeof(glm::ivec3));
		Error += B == A ? 0 : 1;
	}

	{
		...
		glm::ivec4 B;
		std::memcpy(static_cast<void*>(&B), &A, sizeof(glm::ivec4));
		Error += B == A ? 0 : 1;
	}
...
static int test_mat_memcpy()
{
...

	{
		...
		glm::mat2x2 B;
		std::memcpy(static_cast<void*>(&B), &A, sizeof(glm::mat2x2));
...

	{
		...
		glm::mat2x3 B;
		std::memcpy(static_cast<void*>(&B), &A, sizeof(glm::mat2x3));
		Error += glm::all(glm::equal(B, A, glm::epsilon<float>())) ? 0 : 1;
	}

	{
		...
		glm::mat2x4 B;
		std::memcpy(static_cast<void*>(&B), &A, sizeof(glm::mat2x4));
		Error += glm::all(glm::equal(B, A, glm::epsilon<float>())) ? 0 : 1;
	}

	{
		...
		glm::mat3x2 B;
		std::memcpy(static_cast<void*>(&B), &A, sizeof(glm::mat3x2));
		Error += glm::all(glm::equal(B, A, glm::epsilon<float>())) ? 0 : 1;
	}

	{
		...
		glm::mat3x3 B;
		std::memcpy(static_cast<void*>(&B), &A, sizeof(glm::mat3x3));
		Error += glm::all(glm::equal(B, A, glm::epsilon<float>())) ? 0 : 1;
	}

	{
		...
		glm::mat3x4 B;
		std::memcpystatic_cast<void*>(B), &A, sizeof(glm::mat3x4));
		Error += glm::all(glm::equal(B, A, glm::epsilon<float>())) ? 0 : 1;
	}

	{
		...
		glm::mat4x2 B;
		std::memcpy(static_cast<void*>(&B), &A, sizeof(glm::mat4x2));
		Error += glm::all(glm::equal(B, A, glm::epsilon<float>())) ? 0 : 1;
	}

	{
		...
		glm::mat4x3 B;
		std::memcpy(static_cast<void*>(&B), &A, sizeof(glm::mat4x3));
		Error += glm::all(glm::equal(B, A, glm::epsilon<float>())) ? 0 : 1;
	}

	{
		...
		glm::mat4x4 B;
		std::memcpy(static_cast<void*>(&B), &A, sizeof(glm::mat4x4));
		Error += glm::all(glm::equal(B, A, glm::epsilon<float>())) ? 0 : 1;
	}
...
static int test_quat_memcpy()
{
...

	{
		...
		glm::quat B;
		std::memcpy(static_cast<void*>(&B), &A, sizeof(glm::quat));
		Error += glm::all(glm::equal(B, A, glm::epsilon<float>())) ? 0 : 1;
	}
