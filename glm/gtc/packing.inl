...
namespace detail
{
	...
	GLM_FUNC_QUALIFIER glm::uint floatTo11bit(float x)
	{
		...
		uint Pack = 0u;
		memcpy(static_cast<void*>(&Pack), &x, sizeof(Pack));
...
//	}
	...
	struct compute_half<1, Q>
	{
		GLM_FUNC_QUALIFIER static vec<1, uint16, Q> pack(vec<1, float, Q> const& v)
		{
			...
			u16vec1 Packed;
			memcpy(static_cast<void*>(&Packed), &Unpack, sizeof(Packed));
			return Packed;
		}
		...
		{
			i16vec1 Unpack;
			memcpy(static_cast<void*>(&Unpack), &v, sizeof(Unpack));
	...
	GLM_FUNC_QUALIFIER uint16 packUnorm2x8(vec2 const& v)
	{
		...
		uint16 Unpack = 0;
		memcpy(static_cast<void*>(&Unpack), &Topack, sizeof(Unpack));
		return Unpack;
	}
	...
	{
		u8vec2 Unpack;
		memcpy(static_cast<void*>(&Unpack), &p, sizeof(Unpack));
	...
	GLM_FUNC_QUALIFIER uint8 packSnorm1x8(float v)
	{
		...
		uint8 Packed = 0;
		memcpy(static_cast<void*>(&Packed), &Topack, sizeof(Packed));
		return Packed;
	}
	...
	{
		int16 Pack = 0;
		memcpy(static_cast<void*>(&Pack), &v, sizeof(Pack));
		return Pack;
	}
